...
Github is a cloud based code hosting site that allows users to link up and code as a group. The purpose of `GIT` is to allow multiple users work on the same code base. The purpose of `GitHub` is to display your projects publicly and allow others to view or participate.  This assignment will help you create a github repo, and then provides the instructions that will help you format each assignments README file so they are consistent and informative. I discuss README's below.  Remember this file as a reference for turning in all of your assignments.
...
- Create a repository named:
    - `4443-MobileApps`  or
    - `5373-MobileApps`  depending on your section.
- Check the box that says: "Add a README.md file"
- The repo name is important! Copy it exactly. I have scripts that build a URL with your github username and the repo name above. If you don't follow naming conventions, it means your stuff will not be graded or counted late.
...
<sup>(The course info may not match up with your own course. Make changes as appropriate)</sup>
### Markdown Input 
```md
## Albert Einstein
...
|                           **Markdown Output**                           |
| :---------------------------------------------------------------------: |
| <img src="https://images2.imgbox.com/78/48/kXSbpB11_o.png" width="500"> |
